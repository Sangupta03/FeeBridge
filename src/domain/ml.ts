...
// 30 simulated historical cases for gradient descent (doubled for model robustness)
export const TRAINING_DATA: TrainingInstance[] = [
  ...
  // Additional 15 cases to strengthen model convergence
...
// Calculate Regularized Binary Cross-Entropy Loss (L2 penalty)
...
// Returns updated weights, intercept, and the cost/accuracy for this epoch
export function trainStep(
  ...
  // Update parameters with L2 regularization step:
  // w_j = w_j - learningRate * (dW_j / m + (lambda * w_j) / m)
